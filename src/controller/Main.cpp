...
const string attributesPath="../src/data/dataset/attributes.csv";
const string cleanersPath="../src/data/dataset/cleaners.csv";
const string measurementsPath="../src/data/dataset/measurements.csv";
const string providersPath="../src/data/dataset/providers.csv";
const string sensorsPath="../src/data/dataset/sensors.csv";
const string usersPath="../src/data/dataset/users.csv";
